...
Project Jury
Role		Name
Advisor	Orientador	Professor Vitor Fialho, Ph.D.
Examination Committee	Arguente	Professor Luís Pires, Ph.D.
^	Presidente	Professor Fernando Fortes, Ph.D.
---
Block Diagram
...
---
How to use
Upload the firmware `pfc.ino` to the Arduino Nano ESP32.
